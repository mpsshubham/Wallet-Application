...
import com.example.wallet.util.EmailUtil;
...
public class EmailService {
	...
	public static  final String FROM_EMAIL = "mpsshubham@gmail.com"; //requires valid gmail id
	...
	public static void sendEmail(String toEmail,String body)
	{
		...
		EmailUtil.sendEmail(session, toEmail,"Mail from e_wallet", body);
	}
